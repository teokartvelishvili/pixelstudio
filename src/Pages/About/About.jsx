    ...
    <div className="about-container">
      <div className="about-content">
        ...
        <p className="about-text">
          🎊 <strong>Pixel Studio</strong> ჩვენი ფოტო სტუდია არის სივრცე, სადაც
          ხარისხი, კრეატიულობა და პროფესიონალიზმი ერთიანდება. სტუდია გთავაზობთ
          სხვადასხვა ტიპის ფოტოგრაფიას, იქნება ეს პორტრეტული, საქორწილო,
          საოჯახო, პროდუქტის თუ კომერციული ფოტოგრაფია.📸✨
        </p>
        <p className="about-text">
